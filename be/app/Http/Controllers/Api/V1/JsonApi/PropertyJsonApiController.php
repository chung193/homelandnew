        ...
        return response()->json([
            ...
            'data' => [
                ...
                'attributes' => [
                    ...
                    'description' => $property->description,
                    'address' => $property->address,
                    'address-detail' => $property->address_detail,
                    'city' => $property->city,
                    'district' => $property->district,
                    'ward' => $property->ward,
                    ...
                    'legal-info' => $property->legal_info,
                    'status' => $property->status,
                    'created_at' => $property->created_at?->toISOString(),
                    'view-count' => (int) $property->views,
                ...
                'relationships' => [
                    ...
                    'owner' => [
                        'data' => $property->user ? [
                            ...
                            'id' => (string) $property->user->getKey(),
                        ] : null,
                    ],
                ],
            ],
            'included' => [
                ...($property->user ? [[
                    ...
                    'attributes' => [
                        ...
                        'avatar' => $property->user->getFirstMediaUrl('avatar', 'thumb') ?: null,
                        'phone' => $property->user->detail?->phone,
                    ],
                ]] : []),
