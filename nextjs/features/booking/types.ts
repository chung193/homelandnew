...
export type CustomerBookingAction='cancel'|'complete';
export type BookingStatus='pending'|'confirmed'|'in_progress'|'cancelled'|'rejected'|'completed';
...
export type OwnerBookingAction='approve'|'reject'|'start'|'complete';
export type OwnerBookingsResponse={data?:OwnerBooking[];error?:string};
